...
fn timestamp_nanos() -> Result<(), Box<dyn std::error::Error>> {
    let expected = vec![
        ...
        "| id | ts                             | ts_ntz                        |",
        "+----+--------------------------------+-------------------------------+",
        "| 0  | 1970-01-01T00:00:00Z           | 1970-01-01T00:00:00           |",
        "| 1  | 1970-01-01T00:00:00.000000123Z | 1970-01-01T00:00:00.000000123 |",
        "| 2  | 1969-12-31T23:59:59.999999877Z | 1969-12-31T23:59:59.999999877 |",
        "| 3  |                                |                               |",
        "+----+--------------------------------+-------------------------------+",
    ];
